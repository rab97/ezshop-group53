...
public interface EZShopInterface {
        /**
         * This method should reset the application to its base state: balance zero, no
         * transacations, no products
         */
        public void reset();
        ...
        /**
         * This method creates a new user with given username, password and role. The
         * returned value is a unique identifier for the new user.
         *
         * @param username the username of the new user. This value should be unique and
         *                 not empty.
         * @param password the password of the new user. This value should not be empty.
         * @param role     the role of the new user. This value should not be empty and
         *                 it should assume one of the following values :
         *                 "Administrator", "Cashier", "ShopManager"
         *
         * @return The id of the new user ( > 0 ). -1 if there is an error while saving
         *         the user or if another user with the same username exists
         *
         * @throws InvalidUsernameException If the username has an invalid value (empty
         *                                  or null)
         * @throws InvalidPasswordException If the password has an invalid value (empty
         *                                  or null)
         * @throws InvalidRoleException     If the role has an invalid value (empty,
         *                                  null or not among the set of admissible
         *                                  values)
         */
        ...
        // ------------------- ADMIN ------------------ //
        /**
         * This method deletes the user with given id. It can be invoked only after a
         * user with role "Administrator" is logged in.
         *
        ...
        /**
         * This method returns the list of all registered users. It can be invoked only
         * after a user with role "Administrator" is logged in.
         *
         * @return a list of all registered users. If there are no users the list should
         *         be empty
         *
        ...
        /**
         * This method returns a User object with given id. It can be invoked only after
         * a user with role "Administrator" is logged in.
         *
         * @param id the id of the user
         *
         * @return the requested user if it exists, null otherwise
         *
         * @throws InvalidUserIdException if id is less than or equal to zero or if it
         *                                is null
         * @throws UnauthorizedException  if there is no logged user or if it has not
         *                                the rights to perform the operation
         */
        ...
        /**
         * This method updates the role of a user with given id. It can be invoked only
         * after a user with role "Administrator" is logged in.
         *
         * @param id   the id of the user
         ...
         *
         * @throws InvalidUserIdException if the user Id is less than or equal to 0 or
         *                                if it is null
         * @throws InvalidRoleException   if the new role is empty, null or not among
         *                                one of the following : {"Administrator",
         *                                "Cashier", "ShopManager"}
         * @throws UnauthorizedException  if there is no logged user or if it has not
         *                                the rights to perform the operation
         */
        ...
        /**
         * This method lets a user with given username and password login into the
         * system
         *
         * @param username the username of the user
         * @param password the password of the user
         *
         * @return an object of class User filled with the logged user's data if login
         *         is successful, null otherwise ( wrong credentials or db problems)
         *
         ...
         *
         * @return true if the logout is successful, false otherwise (there is no logged
         *         user)
         */
        ...
        /**
         * This method creates a product type and returns its unique identifier. It can
         * be invoked only after a user with role "Administrator" or "ShopManager" is
         * logged in.
         *
         ...
         * @param note         the notes on the product (if null an empty string should
         *                     be saved as description)
         *
         * @return The unique identifier of the new product type ( > 0 ). -1 if there is
         *         an error while saving the product type or if it exists a product with
         *         the same barcode
         *
         * @throws InvalidProductDescriptionException if the product description is null
         *                                            or empty
         * @throws InvalidProductCodeException        if the product code is null or
         *                                            empty, if it is not a number or if
         *                                            it is not a valid barcode
         * @throws InvalidPricePerUnitException       if the price per unit si less than
         *                                            or equal to 0
         * @throws UnauthorizedException              if there is no logged user or if
         *                                            it has not the rights to perform
         *                                            the operation
         */
        public Integer createProductType(String description, String productCode, double pricePerUnit, String note)
                        throws InvalidProductDescriptionException, InvalidProductCodeException,
                        InvalidPricePerUnitException, UnauthorizedException;

        /**
         * This method updates the product id with given barcode and id. It can be
         * invoked only after a user with role "Administrator" or "ShopManager" is
         * logged in.
         *
         ...
         *
         * @return true if the update is successful false if the update is not
         *         successful (no products with given product id or another product
         *         already has the same barcode)
         *
         * @throws InvalidProductIdException          if the product id is less than or
        ...
        /**
         * This method deletes a product with given product id. It can be invoked only
         * after a user with role "Administrator" or "ShopManager" is logged in.
         *
         * @param id the id of the product to be deleted
         *
         * @return true if the product was deleted, false otherwise
         *
         * @throws InvalidProductIdException if the product id is less than or equal to
         *                                   0 or if it is null
         * @throws UnauthorizedException     if there is no logged user or if it has not
         *                                   the rights to perform the operation
         */
        ...
        /**
         * This method returns the list of all registered product types. It can be
        ...
        /**
         * This method returns a product type with given barcode. It can be invoked only
         * after a user with role "Administrator" or "ShopManager" is logged in.
         *
         ...
         *
         * @throws InvalidProductCodeException if barCode is not a valid bar code, if is
         *                                     it empty or if it is null
        ...
        /**
         * This method returns a list of all products with a description containing the
         * string received as parameter. It can be invoked only after a user with role
         * "Administrator" or "ShopManager" is logged in.
         *
         * @param description the description (or part of it) of the products we are
         *                    searching for. Null should be considered as the empty
         *                    string.
         *
         * @return a list of products containing the requested string in their
         *         description
         *
         * @throws UnauthorizedException if there is no logged user or if it has not the
         *                               rights to perform the operation
        ...
        /**
         * This method updates the quantity of product available in store. <toBeAdded>
         * can be negative but the final updated quantity cannot be negative. The
         * product should have a location assigned to it. It can be invoked only after a
         * user with role "Administrator" or "ShopManager" is logged in.
         *
         * @param productId the id of the product to be updated
         * @param toBeAdded the quantity to be added. If negative it decrease the
         *                  available quantity of <toBeAdded> elements.
         *
         * @return true if the update was successful false if the product does not
         *         exists, if <toBeAdded> is negative and the resulting amount would be
        ...
        /**
         * This method assign a new position to the product with given product id. The
         * position has the following format :
         * <aisleNumber>-<rackAlphabeticIdentifier>-<levelNumber> The position should be
         * unique (unless it is an empty string, in this case this means that the
         * product type has not an assigned location). If <newPos> is null or empty it
         * should reset the position of given product type. It can be invoked only after
         * a user with role "Administrator" or "ShopManager" is logged in.
         *
         * @param productId the id of the product to be updated
         * @param newPos    the new position the product should be placed to.
         *
         * @return true if the update was successful false if the product does not
         *         exists or if <newPos> is already assigned to another product
         *
         * @throws InvalidProductIdException if the product id is less than or equal to
         *                                   0 or if it is null
         * @throws InvalidLocationException  if the product location is in an invalid
         *                                   format (not
         ...
         * <pricePerUnit> can differ from the re-selling price of the same product. The
         * product might have no location assigned in this step. It can be invoked only
         * after a user with role "Administrator" or "ShopManager" is logged in.
         *
         * @param productCode  the code of the product that we should order as soon as
         *                     possible
         * @param quantity     the quantity of product that we should order
         * @param pricePerUnit the price to correspond to the supplier (!= than the
         *                     resale price of the shop) per unit of product
         *
         * @return the id of the order (> 0) -1 if the product does not exists, if there
         *         are problems with the db
         *
         * @throws InvalidProductCodeException  if the productCode is not a valid bar
         *                                      code, if it is null or if it is empty
         * @throws InvalidQuantityException     if the quantity is less than or equal to
         *                                      0
         * @throws InvalidPricePerUnitException if the price per unit of product is less
         *                                      than or equal to 0
         * @throws UnauthorizedException        if there is no logged user or if it has
         *                                      not the rights to perform the operation
         */
        ...
        /**
         * This method directly orders and pays <quantity> units of product with given
         * <productCode>, each unit will be payed <pricePerUnit> to the supplier.
         * <pricePerUnit> can differ from the re-selling price of the same product. The
         * product might have no location assigned in this step. This method affects the
         ...
         *                     resale price of the shop) per unit of product
         *
         * @return the id of the order (> 0) -1 if the product does not exists, if the
         *         balance is not enough to satisfy the order, if there are some
        ...
        /**
         * This method saves a new customer into the system. The customer's name should
         * be unique. It can be invoked only after a user with role "Administrator",
        ...
        /**
         * This method updates the data of a customer with given <id>. This method can
         * be used to assign/delete a card to a customer. If <newCustomerCard> has a
         * numeric value than this value will be assigned as new card code, if it is an
         * empty string then any existing card code connected to the customer will be
         * removed and, finally, it it assumes the null value then the card code related
         * to the customer should not be affected from the update. The card code should
         * be unique and should be a string of 10 digits. It can be invoked only after a
         ...
         * @param newCustomerCard the new card code to be assigned. If it is empty it
         *                        means that the card must be deleted, if it is null
         *                        then we don't want to update the cardNumber
         *
         * @return true if the update is successful false if the update fails ( cardCode
         *         assigned to another user, db unreacheable)
         *
         * @throws InvalidCustomerNameException if the customer name is empty or null
         * @throws InvalidCustomerCardException if the customer card is empty, null or
         *                                      if it is not in a valid format (string
         *                                      with 10 digits)
         * @throws UnauthorizedException        if there is no logged user or if it has
         *                                      not the rights to perform the operation
         */
        ...
        /**
         * This method deletes a customer with given id from the system. It can be
         * invoked only after a user with role "Administrator", "ShopManager" or
         * "Cashier" is logged in.
         *
         * @param id the id of the customer to be deleted
         * @return true if the customer was successfully deleted false if the user does
         *         not exists or if we have problems to reach the db
         *
         * @throws InvalidCustomerIdException if the id is null, less than or equal to
         *                                    0.
         * @throws UnauthorizedException      if there is no logged user or if it has
         *                                    not the rights to perform the operation
         */
        ...
        /**
         * This method returns a list containing all registered users. It can be invoked
         * only after a user with role "Administrator", "ShopManager" or "Cashier" is
         * logged in.
         *
        ...
        /**
         * This method returns a string containing the code of a new assignable card. It
         ...
         * It can be invoked only after a user with role "Administrator", "ShopManager"
         * or "Cashier" is logged in.
         *
         ...
         * @throws InvalidCustomerIdException   if the id is null, less than or equal to
         *                                      0.
         * @throws InvalidCustomerCardException if the card is null, empty or in an
         *                                      invalid format
         * @throws UnauthorizedException        if there is no logged user or if it has
         *                                      not the rights to perform the operation
         */
         ...
         * card should always be greater than or equal to 0. It can be invoked only
        ...
        /**
         * This method adds a product to a sale transaction decreasing the temporary
         * amount of product available on the shelves for other customers. It can be
         * invoked only after a user with role "Administrator", "ShopManager" or
         * "Cashier" is logged in.
         *
         ...
         * @return true if the operation is successful false if the product code does
         *         not exist, if the quantity of product cannot satisfy the request, if
        ...
        /**
         * This method deletes a product from a sale transaction increasing the
         * temporary amount of product available on the shelves for other customers. It
         * can be invoked only after a user with role "Administrator", "ShopManager" or
         * "Cashier" is logged in.
         *
         * @param transactionId the id of the Sale transaction
        ...
        /**
         * This method applies a discount rate to all units of a product type with given
         * type in a sale transaction. The discount rate should be greater than or equal
         * to 0 and less than 1. The sale transaction should be started and open. It can
         * be invoked only after a user with role "Administrator", "ShopManager" or
         * "Cashier" is logged in.
         *
         * @param transactionId the id of the Sale transaction
         ...
         *
         * @return true if the operation is successful false if the product code does
         *         not exist, if the transaction id does not identify a started and open
         *         transaction.
         *
         * @throws InvalidTransactionIdException if the transaction id less than or
         *                                       equal to 0 or if it is null
        ...
        /**
         * This method returns a closed sale transaction. It can be invoked only after a
         * user with role "Administrator", "ShopManager" or "Cashier" is logged in.
         *
         * @param transactionId the id of the CLOSED Sale transaction
         *
         * @return the transaction if it is available (transaction closed), null
         *         otherwise
         *
         * @throws InvalidTransactionIdException if the transaction id less than or
         *                                       equal to 0 or if it is null
        ...
        /**
         * This method starts a new return transaction for units of products that have
         * already been sold and payed. It can be invoked only after a user with role
         * "Administrator", "ShopManager" or "Cashier" is logged in.
         *
         * @param transactionId the number of the transaction
         *
         * @return the id of the return transaction (>= 0), -1 if the transaction is not
         *         available.
         *
         * @throws InvalidTransactionIdException if the transactionId is less than or
         *                                       equal to 0 or if it is null
         * @throws UnauthorizedException         if there is no logged user or if it has
         *                                       not the rights to perform the operation
         */
         ...
         * trasaction is undone. This method updates the transaction status (decreasing
        ...
        /**
         * This method deletes a closed return transaction. It affects the quantity of
         * product sold in the connected sale transaction (and consequently its price)
         * and the quantity of product available on the shelves. It can be invoked only
         * after a user with role "Administrator", "ShopManager" or "Cashier" is logged
         * in.
         *
         * @param returnId the identifier of the return transaction to be deleted
         *
         * @return true if the transaction has been successfully deleted, false if it
         *         doesn't exist, if it has been payed, if there are some problems with
         *         the db
         *
         * @throws InvalidTransactionIdException if the transaction id is less than or
         *                                       equal to 0 or if it is null
         * @throws UnauthorizedException         if there is no logged user or if it has
         *                                       not the rights to perform the operation
         */
        ...
        /**
         * This method record the payment of a closed return transaction with given id.
         * The return value of this method is the amount of money to be returned. This
         * method affects the balance of the application. It can be invoked only after a
         * user with role "Administrator", "ShopManager" or "Cashier" is logged in.
         *
         * @param returnId the id of the return transaction
         *
         * @return the money returned to the customer -1 if the return transaction is
         *         not ended, if it does not exist, if there is a problem with the db
         *
         * @throws InvalidTransactionIdException if the return id is less than or equal
         *                                       to 0
         * @throws UnauthorizedException         if there is no logged user or if it has
         *                                       not the rights to perform the operation
         */
        ...
        /**
         * This method record the payment of a return transaction to a credit card. The
         * credit card number validity should be checked. It should follow the luhn
         * algorithm. The credit card should be registered and its balance will be
         * affected. This method affects the balance of the system. It can be invoked
         * only after a user with role "Administrator", "ShopManager" or "Cashier" is
         * logged in.
         *
         * @param returnId   the id of the return transaction
         ...
         *
         * @return the money returned to the customer -1 if the return transaction is
         *         not ended, if it does not exist, if the card is not registered, if
         *         there is a problem with the db
         *
         * @throws InvalidTransactionIdException if the return id is less than or equal
         *                                       to 0
         * @throws InvalidCreditCardException    if the credit card number is empty,
        ...
        /**
         * This method returns a list of all the balance operations
         * (CREDIT,DEBIT,ORDER,SALE,RETURN) performed between two given dates. This
         * method should understand if a user exchanges the order of the dates and act
         * consequently to correct them. Both <from> and <to> are included in the range
         * of dates and might be null. This means the absence of one (or both) temporal
         * constraints.
         *
         *
         * @param from the start date : if null it means that there should be no
         *             constraint on the start date
         * @param to   the end date : if null it means that there should be no
         *             constraint on the end date
         *
